...
has 'rows'     => (is => 'rw', isa => 'PostScript::Barcode::Types::Num',);
has 'columns'  => (is => 'rw', isa => 'PostScript::Barcode::Types::Num',);
...
This document describes C<PostScript::Barcode::datamatrix> version C<0.001>.
...
Type C<PostScript::Barcode::Types::Enum::datamatrix::encoding>
